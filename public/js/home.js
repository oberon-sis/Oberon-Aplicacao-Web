...
async function loadTopCriticalMachines(fkEmpresa) {
  ...
  try {
    const response = await fetch(`/api/maquinas/top-criticas?fkEmpresa=${fkEmpresa}`);
      ...
      container.innerHTML = `
                <div class="col-12">
                    <div class="alert alert-info text-center" role="alert">
                        ...
                        Nenhuma máquina em **Alerta** ou **Crítico** nas últimas 24 horas para o Armando.
                    </div>
                </div>
            `;
      return;
