...
const empresaController = {
  verificar(req, res) {
    ...
    console.log(
      `[CONTROLLER] PASSO 2: Recebi os dados - Razão Social: ${razaoSocial}, CNPJ Limpo: ${cnpjLimpo}`,
    );
    ...
    empresaModel
      .verificarDuplicidade(razaoSocial, cnpjLimpo)
      .then((resultado) => {
        ...
        if (resultado.length > 0) {
          ...
          console.log(
            '[CONTROLLER] ERRO: Encontrei uma duplicata, mas nenhuma condição específica bateu. Enviando resposta 409 genérica.',
          );
