...
const usuarioController = {
    ...
    finalizarCadastro(req, res) {
        ...
        if (!empresa || !usuario || !empresa.razaoSocial || !empresa.cnpj || !usuario.nome || !usuario.cpf || !usuario.email || !usuario.senha) {
        ...
        usuarioModel.cadastrar(empresa, usuario)
            .then(resultado => {
    ...
    getMenu(req, res) {
        ...
        usuarioModel.getMenu(idUsuario)
            .then(resultado => {
                ...
                const menu = {
                    alertaSuportePC: gerarLinkHTML(modulos.home) + (permissoesArray.includes('ver_alertas') ? gerarLinkHTML(modulos.alertas) : '') + (permissoesArray.includes('ver_suporte') ? gerarLinkHTML(modulos.suporte) : ''),
                    ...
                    alertaSuporteMobile: gerarLinkHTML(modulos.home) + (permissoesArray.includes('ver_alertas') ? gerarLinkHTML(modulos.alertas) : '') + (permissoesArray.includes('ver_suporte') ? gerarLinkHTML(modulos.suporte) : ''),
